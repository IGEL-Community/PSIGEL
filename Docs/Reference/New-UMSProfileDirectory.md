...
Module Name: PSIGEL
online version: https://github.com/IGEL-Community/PSIGEL/blob/master/Docs/Reference/New-UMSProfileDirectory.md
schema: 2.0.0
---
...
```powershell
New-UMSProfileDirectory -Computername 'igelrmserver' -WebSession $WebSession -Name '06'
...
```powershell
'05', '06' | New-UMSProfileDirectory -Computername 'igelrmserver' -WebSession $WebSession
