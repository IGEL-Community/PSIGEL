function Get-UMSAPIThinclientAssignment
{
  <#
      .Synopsis
      ...
      .EXAMPLE
      $WebSession = New-UMSAPICookie -Computername 'SRVUMS02' -Username rmdb
      Get-UMSAPIThinclientAssignment -Computername 'SRVUMS02' -WebSession $WebSession -TCID 2433 | Out-GridView
      Gets the profile and master profile assignments for Thinclient with TCID 2433.
      
      .EXAMPLE
      $WebSession = New-UMSAPICookie -Computername 'SRVUMS02' -Username rmdb
      2433 | Get-UMSAPIThinclientAssignment -Computername 'SRVUMS02' -WebSession $WebSession
      Gets the profile and master profile assignments for Thinclient with TCID 2433.
  #>
