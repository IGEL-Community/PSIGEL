...
Describe "$Script:FunctionName Unit Tests" -Tag 'UnitTests' {
  ...
  InModuleScope $Script:ModuleName {
    ...
    Context "General Execution" {
      ...
      It "Send-UMSThinclientSetting -Id 2 Should not throw" {
        { Send-UMSThinclientSetting -Id 2 } | Should -Not -Throw
      }
    }
    ...
    Context "All" {
      ...
      $Result = Send-UMSThinclientSetting -Id 2
    ...
    Context "Whatif" {
      ...
      $Result = Send-UMSThinclientSetting -Id 2 -WhatIf
    ...
    Context "Error Handling" {
      ...
      It "Send-UMSThinclientSetting -Id 2 -ApiVersion 10 -ErrorAction Stop Should throw" {
        { Send-UMSThinclientSetting -Id 2 -ApiVersion 10 -ErrorAction Stop } | Should -Throw
      }
...
Describe "$Script:FunctionName Integration Tests" -Tag "IntegrationTests" {
  ...
  Context "ParameterSetName All" {
    ...
    It "doesn't throw" {
      { $Script:Result = Send-UMSThinclientSetting } | Should Not Throw
    }
