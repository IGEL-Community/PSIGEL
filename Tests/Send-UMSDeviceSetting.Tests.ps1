...
Describe "$Script:FunctionName Unit Tests" -Tag 'UnitTests' {
  ...
  InModuleScope $Script:ModuleName {
    ...
    Context "All" {
      ...
      $Result = Send-UMSDeviceSetting -Id 2
    ...
    Context "Whatif" {
      ...
      $Result = Send-UMSDeviceSetting -Id 2 -WhatIf
    ...
    Context "Error Handling" {
      ...
      It "Send-UMSDeviceSetting -Id 2 -ApiVersion 10 -ErrorAction Stop Should throw" {
        { Send-UMSDeviceSetting -Id 2 -ApiVersion 10 -ErrorAction Stop } | Should -Throw
      }
...
Describe "$Script:FunctionName Integration Tests" -Tag "IntegrationTests" {
  ...
  Context "ParameterSetName All" {
    ...
    It "doesn't throw" {
      { $Script:Result = Send-UMSDeviceSetting } | Should Not Throw
    }
