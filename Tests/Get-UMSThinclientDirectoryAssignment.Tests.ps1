...
Describe "$Script:FunctionName Unit Tests" -Tag 'UnitTests' {
  ...
  Context "Basics" {
    ...
    $KnownParameters = 'Computername', 'TCPPort', 'ApiVersion', 'SecurityProtocol', 'WebSession', 'DirID'
  ...
  InModuleScope $Script:ModuleName {
    ...
    $PSDefaultParameterValues = @{
      ...
      'Get-UMSThinclientDirectoryAssignment:DirID' = 2
    }
    ...
    Context "All" {
      ...
      $Result = Get-UMSThinclientDirectoryAssignment -DirID 2
...
Describe "$Script:FunctionName Integration Tests" -Tags "IntegrationTests" {
  ...
  Context "ParameterSetName All" {
    ...
    It "doesn't throw" {
      { Get-UMSThinclientDirectoryAssignment -DirID 195} | Should Not Throw
    }

    $Result = Get-UMSThinclientDirectoryAssignment -DirID 195
