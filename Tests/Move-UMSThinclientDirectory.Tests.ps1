...
Describe "$Script:FunctionName Unit Tests" -Tag 'UnitTests' {
  ...
  InModuleScope $Script:ModuleName {
    ...
    Context "General Execution" {
      ...
      It 'Move-UMSThinclientDirectory -Id 2 -DDirId 2 Should not throw' {
        { Move-UMSThinclientDirectory -Id 2 -DDirId 2 } | Should -Not -Throw
      }
    ...
    Context "All" {
      ...
      $Result = Move-UMSThinclientDirectory -Id 2 -DDirId 2
    ...
    Context "Whatif" {
      ...
      $Result = Move-UMSThinclientDirectory -Id 2 -DDirId 2 -WhatIf
    ...
    Context "Confirm" {
      ...
      $Result = Move-UMSThinclientDirectory -Id 2 -DDirId 2 -Confirm
    ...
    Context "Error Handling" {
      ...
      It 'Move-UMSThinclientDirectory -Id 2 -DDirId 2 -ApiVersion 10 -ErrorAction Stop Should throw' {
        { Move-UMSThinclientDirectory -Id 2 -DDirId 2 -ApiVersion 10 -ErrorAction Stop } | Should -Throw
      }
