...
Describe "$Script:FunctionName Unit Tests" -Tag 'UnitTests' {
  ...
  InModuleScope $Script:ModuleName {
    ...
    Context "General Execution" {
      ...
      It "Start-UMSEndpoint -Id 2 Should not throw" {
        { Start-UMSEndpoint -Id 2 } | Should -Not -Throw
      }
    }
    ...
    Context "Whatif" {
      ...
      $Result = Start-UMSEndpoint -Id 2 -WhatIf
    ...
    Context "Error Handling" {
      ...
      It "Start-UMSEndpoint -Id 2 -ApiVersion 10 -ErrorAction Stop Should throw" {
        { Start-UMSEndpoint -Id 2 -ApiVersion 10 -ErrorAction Stop } | Should -Throw
      }
...
Describe "$Script:FunctionName Integration Tests" -Tag "IntegrationTests" {
  ...
  Context "ParameterSetName All" {
    ...
    It "doesn't throw" {
      { $Script:Result = Start-UMSEndpoint } | Should Not Throw
    }
