...
Describe "$Script:FunctionName Unit Tests" -Tag 'UnitTests' {
  ...
  InModuleScope $Script:ModuleName {
    ...
    Context "General Execution" {
      ...
      It "Start-UMSThinclient -Id 2 Should not throw" {
        { Start-UMSThinclient -Id 2 } | Should -Not -Throw
      }
    }
    ...
    Context "All" {
      ...
      $Result = Start-UMSThinclient -Id 2
    ...
    Context "Whatif" {
      ...
      $Result = Start-UMSThinclient -Id 2 -WhatIf
    ...
    Context "Error Handling" {
      ...
      It "Start-UMSThinclient -Id 2 -ApiVersion 10 -ErrorAction Stop Should throw" {
        { Start-UMSThinclient -Id 2 -ApiVersion 10 -ErrorAction Stop } | Should -Throw
      }
...
Describe "$Script:FunctionName Integration Tests" -Tag "IntegrationTests" {
  ...
  Context "ParameterSetName All" {
    ...
    It "doesn't throw" {
      { $Script:Result = Start-UMSThinclient } | Should Not Throw
    }
