...
Describe "$Script:ScriptName Unit Tests" -Tag 'UnitTests' {
  ...
  InModuleScope $Script:ModuleName {
    ...
    Context "Whatif" {
      ...
      $Result = Start-UMSDevice -Id 2 -WhatIf
    ...
    Context "Error Handling" {
      ...
      It "Start-UMSDevice -Id 2 -ApiVersion 10 -ErrorAction Stop Should throw" {
        { Start-UMSDevice -Id 2 -ApiVersion 10 -ErrorAction Stop } | Should -Throw
      }
