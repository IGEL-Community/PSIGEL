...
Describe "$Script:FunctionName Unit Tests" -Tag 'UnitTests' {
  ...
  InModuleScope $Script:ModuleName {
    ...
    Context "All" {
      ...
      $Result = Move-UMSProfile -Id 2 -DestId 2
    ...
    Context "Whatif" {
      ...
      $Result = Move-UMSProfile -Id 2 -DestId 2 -WhatIf
    ...
    Context "Confirm" {
      ...
      $Result = Move-UMSProfile -Id 2 -DestId 2 -Confirm
    ...
    Context "Error Handling" {
      ...
      It 'Move-UMSProfile -Id 2 -DestId 2 -ApiVersion 10 -ErrorAction Stop Should throw' {
        { Move-UMSProfile -Id 2 -DestId 2 -ApiVersion 10 -ErrorAction Stop } | Should -Throw
      }
...
Describe "$Script:FunctionName Integration Tests" -Tags "IntegrationTests" {
  ...
  $DestId = (($UMS.ProfileDirectories).where{$_.name -eq '[02]'}).id
