...
Describe "$Script:FunctionName Unit Tests" -Tag 'UnitTests' {
  ...
  InModuleScope $Script:ModuleName {
    ...
    Context "General Execution" {
      ...
      It 'Move-UMSEndpoint -Id 2 -DestId 2 Should not throw' {
        { Move-UMSEndpoint -Id 2 -DestId 2 } | Should -Not -Throw
      }
    ...
    Context "All" {
      ...
      $Result = Move-UMSEndpoint -Id 2 -DestId 2
    ...
    Context "Whatif" {
      ...
      $Result = Move-UMSEndpoint -Id 2 -DestId 2 -WhatIf
    ...
    Context "Error Handling" {
      ...
      It 'Move-UMSEndpoint -Id 2 -DestId 2 -ApiVersion 10 -ErrorAction Stop Should throw' {
        { Move-UMSEndpoint -Id 2 -DestId 2 -ApiVersion 10 -ErrorAction Stop } | Should -Throw
      }
...
Describe "$Script:FunctionName Integration Tests" -Tag "IntegrationTests" {
  ...
  $DestId = $UMS.UMSEndpoint[0].DestId
  ...
  Context "ParameterSetName All" {
    ...
    It "doesn't throw" {
      { $Script:Result = Move-UMSEndpoint } | Should Not Throw
    }
