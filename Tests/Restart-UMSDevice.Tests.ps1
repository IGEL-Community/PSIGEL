...
Describe "$Script:FunctionName Unit Tests" -Tag 'UnitTests' {
  ...
  InModuleScope $Script:ModuleName {
    ...
    Context "Whatif" {
      ...
      $Result = Restart-UMSDevice -Id 2 -WhatIf
    ...
    Context "Error Handling" {
      ...
      It "Restart-UMSDevice -Id 2 -ApiVersion 10 -ErrorAction Stop Should throw" {
        { Restart-UMSDevice -Id 2 -ApiVersion 10 -ErrorAction Stop } | Should -Throw
      }
...
Describe "$Script:FunctionName Integration Tests" -Tag "IntegrationTests" {
  ...
  Context "ParameterSetName All" {
    ...
    It "doesn't throw" {
      { $Script:Result = Restart-UMSDevice } | Should Not Throw
    }
