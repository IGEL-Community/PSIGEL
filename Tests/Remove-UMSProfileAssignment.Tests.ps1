...
Describe "$Script:FunctionName Unit Tests" -Tag 'UnitTests' {
  ...
  InModuleScope $Script:ModuleName {
    ...
    Context "General Execution" {
      ...
      It "Remove-UMSProfileAssignment -Id 2 -ReceiverId 2 -ReceiverType 'tc' Should not throw" {
        { Remove-UMSProfileAssignment -Id 2 -ReceiverId 2 -ReceiverType 'tc' } | Should -Not -Throw
      }
    }
    ...
    Context "tc" {
      ...
      $Result = Remove-UMSProfileAssignment -Id 2 -ReceiverId 2 -ReceiverType 'tc'
      ...
      It "Result.Message should be exactly 'deleted profile assignment.'" {
        $Result.Message | Should Be 'deleted profile assignment.'
      }
      ...
      It 'Result.ReceiverType should be exactly tc' {
        $Result.ReceiverType | Should BeExactly 'tc'
      }
    }
    ...
    Context "tcdirectory" {
      ...
      $Result = Remove-UMSProfileAssignment -Id 2 -ReceiverId 2 -ReceiverType 'tcdirectory'
      ...
      It 'Result.ReceiverType should be exactly tcdirectory' {
        $Result.ReceiverType | Should BeExactly 'tcdirectory'
      }
    }
    ...
    Context "Error Handling" {
      ...
      It "Remove-UMSProfileAssignment -Id 2 -ReceiverId 2 -ReceiverType 'tc' -ApiVersion 10 -ErrorAction Stop Should throw" {
        { Remove-UMSProfileAssignment -Id 2 -ReceiverId 2 -ReceiverType 'tc' -ApiVersion 10 -ErrorAction Stop } | Should -Throw
      }
...
Describe "$Script:FunctionName Integration Tests" -Tag "IntegrationTests" {
  ...
  $Id = $UMS.UMSProfileAssignment[1].Id
  $ReceiverId = $UMS.UMSProfileAssignment[1].ReceiverId
  $ReceiverType = $UMS.UMSProfileAssignment[1].ReceiverType
  ...
  Context "ParameterSetName All" {
    ...
    It "doesn't throw" {
      { $Script:Result = Remove-UMSProfileAssignment } | Should Not Throw
    }
    ...
    It "Result[0].Message should be exactly 'deleted profile assignment.'" {
      $Result[0].Message | Should -BeExactly 'deleted profile assignment.'
    }
  }
}